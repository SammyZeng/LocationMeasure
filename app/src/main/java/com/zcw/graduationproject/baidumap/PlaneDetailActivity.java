...
public class PlaneDetailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				intent.setClass(PlaneDetailActivity.this, CoordinateDetailActivity.class);
	 ...
	 */
	public void init() {
		context = PlaneDetailActivity.this;
		...
		perimeter = intent.getStringExtra("perimeter");
...
//		dbHelper = new MyDBHelper(context, 1);
	...
	public void setEditText() {
		...
		et_perimeter.setEnabled(true);
		et_perimeter.setText(perimeter+" 米");
		et_perimeter.setEnabled(false);
		et_area.setEnabled(true);
		et_area.setText(area+" 平方米");
